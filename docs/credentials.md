...
Purpose: lightly edit the final Telegram forecast text. Weather facts,
source counts, rain strength, and safety recommendations remain deterministic.
If the model output contains forbidden details or loses required facts, the bot
sends the deterministic draft instead.
