  ...
  try {
    const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'Ты кратко формулируешь русский мотопрогноз. Не выдумывай данные, опирайся только на факты. Главный вопрос: ехать ли утром на мото или лучше машина/транспорт.' },
